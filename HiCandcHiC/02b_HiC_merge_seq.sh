...
#SBATCH --job-name HiC_merge_seq # Job name that appear in squeue as well as in output and error text files
...
testRegion="chr9:1,684,357-2,347,949"
...
filePathForTable="${gitDir}/HiCandcHiC/table_HiC_merge_seq.txt"
...
filePathForSizesForBin="${filePathForFasta/.fa/_noUn.fa}.fai"
